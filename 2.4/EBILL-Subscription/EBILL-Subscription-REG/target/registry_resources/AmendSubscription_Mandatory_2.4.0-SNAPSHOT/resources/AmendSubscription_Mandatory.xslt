<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:api="http://api.zuora.com/" xmlns:ns1="http://api.zuora.com/" xmlns:ns2="http://object.api.zuora.com/">
   ...
   <xsl:template match="/">
      <amendSubscription>
         <xsl:choose>
            <xsl:when test="//amendSubscription/sourceId">
               <xsl:copy-of select="//amendSubscription/sourceId"/>
            </xsl:when>
            <xsl:otherwise>
               <faultdescription>
         ...
         <xsl:choose>
            <xsl:when test="//amendSubscription/amend">
               <amend>
                  <xsl:if test="//amendSubscription/amend/amendments">
                              ...
                              <ratePlanData>
                                 <xsl:if test="./ratePlanData/ratePlan">
                                    <ratePlan>
                                       ...
                                       <xsl:if test="./ratePlanData/ratePlan/provisioningEffectiveStartDate">
                                          <xsl:copy-of select="./ratePlanData/ratePlan/provisioningEffectiveStartDate"/>
                                       </xsl:if>
                  ...
                  <xsl:if test="//amendSubscription/amend/amendOptions">
                     <amendOptions>
                        <xsl:if test="//amendSubscription/amend/amendOptions/applyCreditBalance">
                           <xsl:copy-of select="//amendSubscription/amend/amendOptions/applyCreditBalance"/>
                        </xsl:if>
                        <xsl:if test="//amendSubscription/amend/amendOptions/externalPaymentOptions">
                           <externalPaymentOptions>
                              <xsl:if test="//amendSubscription/amend/amendOptions/externalPaymentOptions/amount">
                                 <xsl:copy-of select="//amendSubscription/amend/amendOptions/externalPaymentOptions/amount"/>
                              </xsl:if>
                              <xsl:if test="//amendSubscription/amend/amendOptions/externalPaymentOptions/effectiveDate">
                                 <xsl:copy-of select="//amendSubscription/amend/amendOptions/externalPaymentOptions/effectiveDate"/>
                              </xsl:if>
                              <xsl:if test="//amendSubscription/amend/amendOptions/externalPaymentOptions/gatewayOrderId">
                                 <xsl:copy-of select="//amendSubscription/amend/amendOptions/externalPaymentOptions/gatewayOrderId"/>
                              </xsl:if>
                              <xsl:if test="//amendSubscription/amend/amendOptions/externalPaymentOptions/paymentMethodId">
                                 <xsl:copy-of select="//amendSubscription/amend/amendOptions/externalPaymentOptions/paymentMethodId"/>
                              </xsl:if>
                              <xsl:if test="//amendSubscription/amend/amendOptions/externalPaymentOptions/referenceId">
                                 <xsl:copy-of select="//amendSubscription/amend/amendOptions/externalPaymentOptions/referenceId"/>
                              </xsl:if>
                           </externalPaymentOptions>
                        </xsl:if>
                        <xsl:if test="//amendSubscription/amend/amendOptions/invoiceProcessingOptions">
                           <invoiceProcessingOptions>
                              <xsl:if test="//amendSubscription/amend/amendOptions/invoiceProcessingOptions/invoiceDate">
                                 <xsl:copy-of select="//amendSubscription/amend/amendOptions/invoiceProcessingOptions/invoiceDate"/>
                              </xsl:if>
                              <xsl:if test="//amendSubscription/amend/amendOptions/invoiceProcessingOptions/invoiceTargetDate">
                                 <xsl:copy-of select="//amendSubscription/amend/amendOptions/invoiceProcessingOptions/invoiceTargetDate"/>
                              </xsl:if>
                           </invoiceProcessingOptions>
                        </xsl:if>
                        <xsl:if test="//amendSubscription/amend/amendOptions/generateInvoice">
                           <xsl:copy-of select="//amendSubscription/amend/amendOptions/generateInvoice"/>
                        </xsl:if>
                        <xsl:if test="//amendSubscription/amend/amendOptions/processPayments">
                           <xsl:copy-of select="//amendSubscription/amend/amendOptions/processPayments"/>
                        </xsl:if>
                     </amendOptions>
                  </xsl:if>
                  <xsl:if test="//amendSubscription/amend/previewOptions">
                     <previewOptions>
                        <xsl:if test="//amendSubscription/amend/previewOptions/numberOfPeriods">
                           <xsl:copy-of select="//amendSubscription/amend/previewOptions/numberOfPeriods"/>
                        </xsl:if>
                        <xsl:if test="//amendSubscription/amend/previewOptions/previewThroughTermEnd">
                           <xsl:copy-of select="//amendSubscription/amend/previewOptions/previewThroughTermEnd"/>
                        </xsl:if>
                        <xsl:if test="//amendSubscription/amend/previewOptions/previewType">
                           <xsl:copy-of select="//amendSubscription/amend/previewOptions/previewType"/>
                        </xsl:if>
                     </previewOptions>
                  </xsl:if>
               </amend>
         ...
         <xsl:choose>
            <xsl:when test="//amendSubscription/callbackURL">
               <xsl:copy-of select="//amendSubscription/callbackURL"/>
            </xsl:when>
            <xsl:otherwise>
               <faultdescription>
