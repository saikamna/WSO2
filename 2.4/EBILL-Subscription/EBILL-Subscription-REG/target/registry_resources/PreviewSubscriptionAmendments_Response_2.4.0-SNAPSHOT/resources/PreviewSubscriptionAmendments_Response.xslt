...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns1="http://api.zuora.com/" xmlns:fns="http://fault.api.zuora.com" xmlns:ns2="http://object.api.zuora.com/" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:v1="http://www.schneider-electric.com/ifw/common/message/SoapHeader/v1" version="1.0">
   <xsl:output method="xml" version="1.0" encoding="UTF-8" />
   <xsl:template match="/">
            <previewSubscriptionAmendmentsResponse>
               <xsl:for-each select="//ns1:amendResponse/ns1:results">
                  <amendResponse>
                     <xsl:if test="string-length(//ns1:amendResponse/ns1:results/ns1:AmendmentIds)!=0">
					    <xsl:for-each select="//ns1:amendResponse/ns1:results/ns1:AmendmentIds">
                        <amendmentIds>
                           <xsl:value-of select="." />
                        </amendmentIds>
						</xsl:for-each>
                     ...
                     <xsl:if test="count(//ns1:amendResponse/ns1:results/ns1:ChargeMetricsData/ns1:ChargeMetrics)!=0">
                        <chargeMetricsData>
                           <xsl:for-each select="//ns1:amendResponse/ns1:results/ns1:ChargeMetricsData/ns1:ChargeMetrics">
                              <chargeMetrics>
                     ...
                     <xsl:if test="count(//ns1:amendResponse/ns1:results/ns1:Errors)!=0">
                        <xsl:for-each select="//ns1:amendResponse/ns1:results/ns1:Errors">
                           <errorMessage>
                              <errorCode>
                     ...
                     <xsl:if test="string-length(//ns1:amendResponse/ns1:results/ns1:GatewayResponse)!=0">
                        <gatewayResponse>
                           <xsl:value-of select="//ns1:amendResponse/ns1:results/ns1:GatewayResponse" />
                        </gatewayResponse>
                     </xsl:if>
                     <xsl:if test="string-length(//ns1:amendResponse/ns1:results/ns1:GatewayResponseCode)!=0">
                        <gatewayResponseCode>
                           <xsl:value-of select="//ns1:amendResponse/ns1:results/ns1:GatewayResponseCode" />
                        </gatewayResponseCode>
                     </xsl:if>
                     <xsl:if test="count(//ns1:amendResponse/ns1:results/ns1:InvoiceDatas/ns1:Invoice)!=0">
								<xsl:for-each select="//ns1:amendResponse/ns1:results/ns1:InvoiceDatas">
                        <invoiceDatas>
                           
                              <xsl:if test="string-length(./ns1:Invoice)!=0">
                                 <invoice>
                                    <xsl:if test="string-length(./ns1:Invoice/ns2:Id)!=0">
                                       <id>
                                          <xsl:value-of select="./ns1:Invoice/ns2:Id" />
                                       </id>
                                    </xsl:if>
                     ...
                     <xsl:if test="string-length(//ns1:amendResponse/ns1:results/ns1:InvoiceId)!=0">
                        <invoiceId>
                           <xsl:value-of select="//ns1:amendResponse/ns1:results/ns1:InvoiceId" />
                        </invoiceId>
                     </xsl:if>
                     
                  
                     <xsl:if test="string-length(//ns1:amendResponse/ns1:results/ns1:PaymentId)!=0">
                        <paymentId>
                           <xsl:value-of select="//ns1:amendResponse/ns1:results/ns1:PaymentId" />
                        </paymentId>
                     </xsl:if>
                     <xsl:if test="string-length(//ns1:amendResponse/ns1:results/ns1:PaymentTransactionNumber)!=0">
                        <paymentTransactionNumber>
                           <xsl:value-of select="//ns1:amendResponse/ns1:results/ns1:PaymentTransactionNumber" />
                        </paymentTransactionNumber>
                     </xsl:if>
                     <xsl:if test="string-length(//ns1:amendResponse/ns1:results/ns1:SubscriptionId)!=0">
                        <subscriptionId>
                           <xsl:value-of select="//ns1:amendResponse/ns1:results/ns1:SubscriptionId" />
                        </subscriptionId>
                     </xsl:if>
                    
                     <success>
                        <xsl:value-of select="//ns1:amendResponse/ns1:results/ns1:Success" />
                     </success>
                     <xsl:if test="string-length(//ns1:amendResponse/ns1:results/ns1:TotalDeltaMrr)!=0">
                        <totalDeltaMrr>
                           <xsl:value-of select="//ns1:amendResponse/ns1:results/ns1:TotalDeltaMrr" />
                        </totalDeltaMrr>
                     </xsl:if>
                     <xsl:if test="string-length(//ns1:amendResponse/ns1:results/ns1:TotalDeltaTcv)!=0">
                        <totalDeltaTcv>
                           <xsl:value-of select="//ns1:amendResponse/ns1:results/ns1:TotalDeltaTcv" />
                        </totalDeltaTcv>
                     </xsl:if>
                  </amendResponse>
               </xsl:for-each>
